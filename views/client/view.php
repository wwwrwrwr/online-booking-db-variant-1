...
<div class="card mb-4">
    ...
    <div class="card-body">
      <h5><?= htmlspecialchars(KaTeX parse error: Expected 'EOF', got '&' at position 8: client[&̲#39;last_name&#…client['first_name'] . ' ' . ($client['patronymic'] ?? '')) ?></h5>
